...
import AppDataGrid from "../common/form/AppDataGrid";
import { type GridColDef } from "@mui/x-data-grid";
import { Button } from "@mui/material";
import { DocTypesAPI, type DocType } from "../common/data/doc-types";

const ImageMeDashboard = () => {
...
export default ImageMeDashboard;
